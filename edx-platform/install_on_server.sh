...
# May 2020
#
# To stand up a pristine single-server instance of Open edX Ironwood master
...
# 4. Install Open edX:
wget https://raw.githubusercontent.com/nikhilkanta/configuration/$OPENEDX_RELEASE/util/install/native.sh -O - | bash > install.out
